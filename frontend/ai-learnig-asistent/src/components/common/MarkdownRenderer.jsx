...
import SyntaxHighlighter, { Prism as syntaxHighligter } from "react-syntax-highlighter";
        ...
        components={{
          ...
          code: ({ node, inline, className, children, ...props }) => {
            ...
            return !inline && match ? (
              ...
              <code className="bg-neutral-100 rounded font-mono text-sm" {...props}>
                {children}
              </code>
            );
          },
          pre: ({ node, ...props }) => <pre className="bg-neutral-800 text-white p-3 runded-md overflow-x-auto font-mono text-sm my-4" {...props} />,
        }}
      >
        {content}
      </ReactMarkdown>
