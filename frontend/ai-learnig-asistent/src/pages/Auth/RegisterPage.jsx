...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (password.length < 6) {
      setError("Password mus must be at least 6 characters long.");
      return;
    }
    ...
    try {
      ...
      toast.success("Registration is successfully! Please login.");
      navigate("/login");
    } catch (err) {
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
          ...
          <form className="space-y-5">
            ...
            >
              ...
              <div className="absolute inset-0 bg-linear-to-r from-white/0 via-white/20 to-white/0 translate-x[-100%] group-hover:translate-x-full transition-transform duration-700" />
            </button>
          </form>
